<?php
	...
	if($grava)
{
    echo "Cadastro Efetuado com sucesso, Clique abaixo para fazer login e continuar compra";
} 
else 
{
...
?>
 ...
 <br><br><br><br><center><a href="loginfinaliza.php"><img src="img/finalizarcompra.png"></a></center>
