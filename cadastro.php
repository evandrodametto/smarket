<script>
    function cor(cores){
            ...
            $(".logo").css("background-color", cores); 
           // $(".btn-cadastrar").css("background-color", cores); 
            $(".container ").css("background-color", cores); 
			
		
			$("p").css("color", "white");
				$("#textobranco").css("color", "white");
				$("#formulario").css("color", "white");
				$("#nomecompleto").css("color", "white");
