...
<!-- script para ocultar e mostrar div  -->
<script>
...
<script type="text/javascript" src="altera_display.js"></script>
	...
	<div id="col1">
		...
		<center><h1>PAGAMENTO COM CARTÃO DE CRÉDITO</h1></center><BR><BR><BR><BR>
	<a href="#" onclick="javascript: altera_display('atual');"> <img src="img/endereco_atual.png"></a>
	<div id="atual" style="display: none">
<form action="pagcartao.php" method="post">
 <div class="formulario"> 
	<?php
     
	 
	  include("endatual.php");
...
<br><br><br>
<a href="#" onclick="javascript: altera_display('novo');"> <img src="img/endereco_novo.png"></a>
