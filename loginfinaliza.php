...
<img src="img/amenos.png" id="btnDiminuir" height="25" width="25">
 ...
 <?php
		 ...
		 ?>
		 <center><section><form action="validafinalizar.php" method="post"  style="background-color:rgba(255, 255, 255, 0.7); width:400px; borde:200px; border-radius: 10px; "><br><br>
		 <label> Digite seu Login: </label>
		   ...
		   <br><br><br>
		   <p><input type="image" class="botao" src="img/entrar2.png"><br><br>
		 </form>
		 
<br><br>
                <a href="cadastrofinaliza.php"><img src="img/cadastrar.png"></a>
