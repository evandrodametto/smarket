...
<?php
	include("config/conexao.php");
	 ...
	 $query = "insert into pagcartao(nome,id_usuario,id_mercado, ed, n, ba, total, troco, tipo_pag,data,horario) values ('$nome','$id','$mercado','$ende', '$numero', '$bairro','$total','$total','vale','$data','$hora')";
